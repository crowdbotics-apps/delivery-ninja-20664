"""delivery_ninja_20664 URL Configuration
...
admin.site.site_header = "Delivery Ninja"
admin.site.site_title = "Delivery Ninja Admin Portal"
admin.site.index_title = "Delivery Ninja Admin"

# swagger
api_info = openapi.Info(
    title="Delivery Ninja API",
    default_version="v1",
    description="API documentation for Delivery Ninja App",
)
